<html>
   ...
   <body>
        <BR><center><h1>Chemin à suivre pour BTS CCST</h1><BR></center>
        <?php
            ...
            $reponse = $bdd->query('SELECT * FROM CCST');
            $activeClass = 'active';
            ...
            while ($donnees = $reponse->fetch())
            {
                echo '<div class="carousel-item ' . $activeClass . '">
                        <img class="d-block w-100" src="Images/CCST/'.$donnees['Img'].'" alt="Image slide">
                    </div>';
                $activeClass = '';
            }
