<html>
   ...
   <body>
        <BR><center><h1>Chemin à suivre pour BTS CIEL</h1><BR></center>
        <?php
            include("connexion.php");
            try
            {
                $bdd = new bdd('mysql:host=host;dbname=dbname;charset=utf8', 'root', 'root');
            }
            catch (Exception $e)
            {
            ...
            while ($donnees = $reponse->fetch())
            {
                echo '<div class="carousel-item ' . $activeClass . '">
                        <img class="d-block w-100" src="Images/CIEL/'.$donnees['Img'].'" alt="Image slide">
                    </div>';
                $activeClass = '';
            }
