<html>
   ...
   <body>
        <BR><center><h1>Chemin à suivre pour BTS CRSA</h1><BR></center>
        <?php
            ...
            $reponse = $bdd->query('SELECT * FROM CRSA');
            $activeClass = 'active';
            ...
            while ($donnees = $reponse->fetch())
            {
                echo '<div class="carousel-item ' . $activeClass . '">
                        <img class="d-block w-100" src="Images/CRSA/'.$donnees['Img'].'" alt="Image slide">
                    </div>';
                $activeClass = '';
            }
